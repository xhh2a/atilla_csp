...
from data_classes.types import Modifier, ModifierType, UnitType, VariableType, ModifierLocation
...
BUILDING_CHAINS = [
    Building(
        ...
        modifiers=[
            ...
            Modifier(type=ModifierType.FLAT, variable=VariableType.PUBLIC_ORDER, value=-6),
            Modifier(type=ModifierType.FLAT, variable=VariableType.COMMERCE, value=2500),
    ...
    Building(
        ...
        modifiers=[
            Modifier(type=ModifierType.FLAT, variable=VariableType.SANITATION, location=ModifierLocation.SETTLEMENT, value=-6),
            Modifier(type=ModifierType.FLAT, variable=VariableType.RECRUITMENT_CAPACITY, sub_category=UnitType.NAVAL, value=2),
            Modifier(type=ModifierType.FLAT, variable=VariableType.UNIT_LEVEL, sub_category=UnitType.NAVAL, value=2),
